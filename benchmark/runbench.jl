...
const Target_Package_Path = haskey(ENV, "BENCH_TARGET_PATH") ?
    abspath(ENV["BENCH_TARGET_PATH"]) :
    error("BENCH_TARGET_PATH is required for ClapeyronBenchmarks runs.")
...
const Benchledger_Metadata_Defaults = (
    ...
    logo_url="https://raw.githubusercontent.com/ClapeyronThermo/Clapeyron.jl/master/docs/src/assets/logos/Clapeyron_logo.svg",
